...
{                                                       //Line 7
    ...
    try                                                 //Line 11
    {                                                   //Line 12
        cout << "Line 13: Enter the radius " << "of a circle: ";                        //Line 13
        cin >> radius;                                  //Line 14
        cout << endl;                                   //Line 15
        circle.setRadius(radius);                       //Line 16
        cout << "Line 17: circle - " << "radius: " << circle.getRadius() << ", area: " << circle.area()
             << ", circumference: " << circle.circumference() << endl;         //Line 17
    }                                                   //Line 18
